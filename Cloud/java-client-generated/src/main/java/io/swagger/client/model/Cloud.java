...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-08-21T12:59:26.207360319Z[GMT]")
...
public class Cloud {
   ...
   * @return cloudId
  **/
  @Schema(example = "ff88hjk", description = "")
   ...
   * @return idClient
  **/
  @Schema(example = "ff88hjk", required = true, description = "")
  ...
  **/
   ...
   * @return CPU
  **/
  @Schema(example = "6", required = true, description = "количество ядер процессора")
